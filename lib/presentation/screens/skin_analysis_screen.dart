    ...
    return _PageShell(
      ...
      child: Column(
        children: [
          ...
          const SizedBox(height: 14),
          _AiResultDisclaimer(locale: locale),
          const SizedBox(height: 24),
          _GlassCard(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
...
class _AiResultDisclaimer extends StatelessWidget {
  const _AiResultDisclaimer({required this.locale});
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Row(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          const Icon(Icons.info_outline, color: Color(0xFF9A6A00), size: 20),
          const SizedBox(width: 10),
          Expanded(
            child: Text(
              l.t(
                'Lưu ý: Kết quả này do AI tạo ra, chỉ nhằm mục đích tham khảo và chăm sóc thẩm mỹ. Đây không phải chẩn đoán, điều trị hay tư vấn y tế. Nếu bạn có triệu chứng nghiêm trọng, kích ứng kéo dài hoặc bệnh lý da, hãy tham khảo bác sĩ da liễu.',
                'Disclaimer: This result is generated by AI for informational and cosmetic skincare guidance only. It is not a medical diagnosis, treatment, or medical advice. For severe symptoms, persistent irritation, or skin conditions, please consult a dermatologist.',
              ),
